...
<div id="help-panel" class="panel-left">
    ...
    <div class="panel-aside">
        ...
        <a class="button button-primary" href="<?php echo esc_url( 'https://demo.wpdelicious.com/' . YUMMY_BITES_THEME_TEXTDOMAIN . '/'); ?>" title="<?php esc_attr_e( 'Visit the Demo', 'yummy-bites' ); ?>" target="_blank">
