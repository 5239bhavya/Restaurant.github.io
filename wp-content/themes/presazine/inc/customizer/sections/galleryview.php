...
$wp_customize->add_section( 'section_home_galleryview',
	array(
		'title'      => __( 'Featured Posts Posts', 'presazine' ),
		'capability' => 'edit_theme_options',
		'panel'      => 'home_page_panel',
		'active_callback' => 'presazine_galleryview_design_enable',
		)
);
...
$wp_customize->add_control( new Presazine_Switch_Control( $wp_customize, 'theme_options[disable_galleryview_section]',
    array(
		'label' 			=> __('Enable/Disable Featured Posts Section', 'presazine'),
...
$wp_customize->add_control( 'theme_options[galleryview_content_align]', array(
	...
	'section'           => 'section_home_galleryview',
	'type'              => 'radio',
	'active_callback' => 'presazine_galleryview_active',
	'choices'				=> array( 
...
$wp_customize->add_setting( 'theme_options[galleryview_category_enable]', array(
	'default'           => $default['galleryview_category_enable'],
	'sanitize_callback' => 'presazine_sanitize_checkbox',
) );

$wp_customize->add_control( 'theme_options[galleryview_category_enable]', array(
...
$wp_customize->add_control(
	new Presazine_Dropdown_Taxonomies_Control( $wp_customize, 'theme_options[galleryview_category]',
		array(
