...
?>
<?php 
$enable_video = presazine_get_option( 'single_page_video_enable' );
$enable_image = presazine_get_option( 'single_page_image_enable' );
$enable_header_image     = presazine_get_option( 'single_page_header_image_enable' ); ?>
