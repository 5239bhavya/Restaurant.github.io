...
function yummy_bites_gutenberg_inline_style(){
    ...
    $custom_css = ':root .block-editor-page {
        ...
        --yummy-btn-roundness-top   : ' . absint( $button_roundness['top'] ) . 'px;
        --yummy-btn-roundness-right : ' . absint( $button_roundness['right'] ) . 'px;
        --yummy-btn-roundness-bottom: ' . absint( $button_roundness['bottom'] ) . 'px;
        --yummy-btn-roundness-left  : ' . absint( $button_roundness['left'] ) . 'px;
        --yummy-btn-padding-top     : ' . absint( $button_padding['top'] ) . 'px;
        --yummy-btn-padding-right   : ' . absint( $button_padding['right'] ) . 'px;
        --yummy-btn-padding-bottom  : ' . absint( $button_padding['bottom'] ) . 'px;
        --yummy-btn-padding-left    : ' . absint( $button_padding['left'] ) . 'px;
    }
